        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PercentChangeOneHour = table.Column<float>(type: "real", nullable: false),
                    PercentChangeTwentyFourHours = table.Column<float>(type: "real", nullable: false),
                    MarketCap = table.Column<decimal>(type: "numeric", nullable: false),
                    LastUpdated = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    IsActual = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    CryptocurrencyId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CryptoQuote", x => x.Id);
                    table.ForeignKey(
